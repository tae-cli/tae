...
module Cucumber
  ...
  def self.file_mode(m, encoding = nil); end
  def self.logger; end
...
class Anonymous_Cucumber_Core_Event_21 < Cucumber::Core::Event
  def attributes; end
  def event_id; end
...
class Cucumber::Events::TestRunStarted < Anonymous_Cucumber_Core_Event_21
  def test_cases; end
end
...
class Anonymous_Cucumber_Core_Event_22 < Cucumber::Core::Event
  def attributes; end
  def body; end
  def event_id; end
  def initialize(*args); end
...
class Cucumber::Events::GherkinSourceRead < Anonymous_Cucumber_Core_Event_22
  def body; end
  def path; end
end
...
class Anonymous_Cucumber_Core_Event_23 < Cucumber::Core::Event
  def attributes; end
  def event_id; end
  def initialize(*args); end
  def step_match; end
...
class Cucumber::Events::StepActivated < Anonymous_Cucumber_Core_Event_23
  def initialize(test_step, step_match); end
  def step_match; end
  def test_step; end
end
class Anonymous_Cucumber_Core_Event_24 < Cucumber::Core::Event
  def attributes; end
  def event_id; end
  def initialize(*args); end
...
class Cucumber::Events::StepDefinitionRegistered < Anonymous_Cucumber_Core_Event_24
...
class Anonymous_Cucumber_Core_Event_25 < Cucumber::Core::Event
  def attributes; end
  def event_id; end
  def initialize(*args); end
  def to_h; end
end
class Cucumber::Events::TestRunFinished < Anonymous_Cucumber_Core_Event_25
end
...
class Cucumber::MultilineArgument::DataTable
  ...
  def self.from(data, location = nil); end
  def self.from_array(data, location = nil); end
  def self.parse(text, location = nil); end
  def symbolic_hashes; end
  def symbolize_key(key); end
  def to_hash(cells); end
...
class InvalidName___Class_0x00___Builder_26
...
class Cucumber::Filters::ActivateSteps < Anonymous_Object_27
  def test_case(test_case); end
end
...
class Cucumber::Filters::ApplyAfterStepHooks < Anonymous_Object_28
  def test_case(test_case); end
end
class Anonymous_Object_29
  def done; end
  def hooks; end
  def initialize(*args); end
  def receiver; end
...
class Cucumber::Filters::ApplyBeforeHooks < Anonymous_Object_29
  def test_case(test_case); end
end
class Anonymous_Object_30
  def done; end
  def hooks; end
  def initialize(*args); end
  def receiver; end
...
class Cucumber::Filters::ApplyAfterHooks < Anonymous_Object_30
  def test_case(test_case); end
end
class Anonymous_Object_31
  def done; end
  def hooks; end
  def initialize(*args); end
  def receiver; end
...
class Cucumber::Filters::ApplyAroundHooks < Anonymous_Object_31
  def test_case(test_case); end
end
class Anonymous_Object_32
  def config; end
  def done; end
  def initialize(*args); end
  def receiver; end
...
class Cucumber::Filters::BroadcastTestRunStartedEvent < Anonymous_Object_32
  def done; end
...
class Cucumber::RunningTestCase::Builder
  ...
  def scenario(_scenario); end
  def scenario_outline(_scenario); end
end
class Cucumber::RunningTestCase::Scenario < SimpleDelegator
...
class Cucumber::RunningTestCase::ScenarioOutlineExample < Cucumber::RunningTestCase::Scenario
  def cell_values; end
  def outline?; end
  def scenario_outline; end
end
class Anonymous_Object_33
  def done; end
  def initialize(*args); end
  def receiver; end
  def runtime; end
...
class Cucumber::Filters::PrepareWorld < Anonymous_Object_33
  def test_case(test_case); end
end
...
class Cucumber::Filters::Retry < Anonymous_Object_34
...
class Cucumber::Runtime
  ...
  def create_formatter(factory, formatter_options, path_or_io, cli_options); end
  ...
  def legacy_formatter?(factory); end
  def load_step_definitions; end
  def log; end
  def report; end
  def results; end
  def run!; end
  def scenarios(status = nil); end
  def steps(status = nil); end
...
class Cucumber::Runtime::StepHooks
  ...
  def initialize(hooks); end
end
module Cucumber::Hooks
  def self.after_hook(source, location, &block); end
  def self.after_step_hook(source, location, &block); end
  def self.around_hook(_source, &block); end
  def self.before_hook(source, location, &block); end
  def self.build_hook_step(source, location, block, hook_type, action_type); end
end
...
class Cucumber::Runtime::BeforeHooks
  ...
  def before_hooks(source); end
  def initialize(hooks, scenario); end
end
class Cucumber::Runtime::AfterHooks
  def after_hooks(source); end
  def apply_to(test_case); end
  def initialize(hooks, scenario); end
end
...
class Cucumber::Runtime::SupportCode
  ...
  def invoke_dynamic_steps(steps_text, i18n, _location); end
...
class Cucumber::StepArgument
  ...
  def offset; end
  def self.arguments_from(regexp, step_name); end
  def val; end
end
...
module Cucumber::Formatter::LegacyApi
end
module Cucumber::Formatter::LegacyApi::Ast
end
class Cucumber::Formatter::LegacyApi::Ast::Node
  def accept(formatter); end
  def initialize(node = nil); end
  def node; end
end
class Cucumber::Formatter::LegacyApi::Ast::NullLanguage
  def method_missing(*_args, &_block); end
  def to_ary; end
end
class Cucumber::Formatter::LegacyApi::Ast::HookResultCollection
  def <<(child); end
  def accept(formatter); end
  def describe_exception_to(formatter); end
  def initialize; end
  def send_output_to(formatter); end
end
class Cucumber::Formatter::LegacyApi::Ast::Comments < Struct
  def accept(formatter); end
  def comments; end
  def comments=(_); end
  def self.[](*arg0); end
...
class Cucumber::Formatter::LegacyApi::Ast::HookResult
  def accept(formatter); end
  def describe_exception_to(formatter); end
  def initialize(result, messages, embeddings); end
  def send_output_to(formatter); end
end
class Cucumber::Formatter::LegacyApi::Ast::StepInvocation < Struct
  def accept(formatter); end
  ...
  def indent; end
  def indent=(_); end
  def keyword(*args, &block); end
  def location(*args, &block); end
  def messages; end
  def messages=(_); end
  def multiline_arg(*args, &block); end
  def passed?; end
  def print_exception(formatter); end
  def print_step_name(formatter); end
  def self.[](*arg0); end
  def self.inspect; end
  def self.members; end
  def self.new(*arg0); end
  def source_indent; end
  def status; end
  def status=(_); end
  def step; end
  def step=(_); end
  ...
  def step_match; end
  def step_match=(_); end
  def step_result_attributes; end
  def text(*args, &block); end
  def to_s; end
  extend Forwardable
end
class Cucumber::Formatter::LegacyApi::Ast::StepInvocations < Array
  def exception; end
  def failed?; end
  def failed_step; end
  def passed?; end
...
class Cucumber::Formatter::LegacyApi::Ast::DataTableRow
  ...
  def dom_id; end
  def exception; end
  def initialize(row, line); end
  def line; end
  def status; end
  def values; end
end
class Cucumber::Formatter::LegacyApi::Ast::ExampleTableRow < Struct
  def cells; end
  def cells=(_); end
  def exception; end
  def exception=(_); end
...
class Cucumber::Formatter::LegacyApi::Ast::LegacyTableRow < Cucumber::Formatter::LegacyApi::Ast::DataTableRow
  def accept(formatter); end
end
class Cucumber::Formatter::LegacyApi::Ast::Tags < Struct
  def accept(formatter); end
  def self.[](*arg0); end
  def self.inspect; end
  def self.members; end
...
class Cucumber::Formatter::LegacyApi::Ast::Scenario < Struct
  def backtrace_line(step_name = nil, line = nil); end
  def failed?; end
  def line; end
  def location; end
  def location=(_); end
...
class Cucumber::Formatter::LegacyApi::Ast::ScenarioOutline < Struct
  def backtrace_line(step_name = nil, line = nil); end
  def failed?; end
  def line; end
  def location; end
...
module Cucumber::Formatter::LegacyApi::Ast::MultilineArg
  def self.for(node); end
end
class Cucumber::Formatter::LegacyApi::Ast::MultilineArg::Builder
  def data_table(node); end
  def doc_string(node); end
  def initialize(node); end
  def legacy_table(node); end
  def result; end
end
class Cucumber::Formatter::LegacyApi::Ast::MultilineArg::DocString < Cucumber::Formatter::LegacyApi::Ast::Node
  def accept(formatter); end
end
class Cucumber::Formatter::LegacyApi::Ast::MultilineArg::DataTable < Cucumber::MultilineArgument::DataTable
  def accept(formatter); end
  def node; end
end
class Cucumber::Formatter::LegacyApi::Ast::LegacyTable < SimpleDelegator
  def accept(formatter); end
end
class Cucumber::Formatter::LegacyApi::Ast::Features < Struct
  def duration; end
  def duration=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class Cucumber::Formatter::LegacyApi::Ast::Background < SimpleDelegator
  def feature; end
  def initialize(feature, node); end
end
class Cucumber::Formatter::LegacyApi::Adapter < Struct
  def ask(*args, &block); end
  def collect_matches; end
  def config; end
  def config=(_); end
  def embed(*args, &block); end
  def emit_deprecation_warning; end
  def formatter; end
  def formatter=(_); end
  def formatter_class_name; end
  def initialize(*arg0); end
  def printer; end
  def puts(*messages); end
  def record_test_case_result(test_case, result); end
  def results; end
  def results=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class Cucumber::Formatter::LegacyApi::FeaturesPrinter < Struct
  def after; end
  def after_test_case(*args); end
  def after_test_step(test_step, result); end
  def before; end
  ...
  def config=(_); end
  def embed(src, mime_type, label); end
  def examples_table(node, *arg1); end
  def examples_table_row(node, *arg1); end
  def feature(node, *arg1); end
  def formatter; end
  def formatter=(_); end
  def matches; end
  def matches=(_); end
  ...
  def results; end
  def results=(_); end
  def scenario(node, *arg1); end
  def scenario_outline(node, *arg1); end
  def self.[](*arg0); end
  def self.inspect; end
  def self.members; end
  def self.new(*arg0); end
...
module Cucumber::Formatter::LegacyApi::TestCaseSource
  def self.for(test_case, result); end
end
class Cucumber::Formatter::LegacyApi::TestCaseSource::Collector
  def initialize; end
  def method_missing(name, node, _test_case_result, *_args); end
  def result; end
end
class Cucumber::Formatter::LegacyApi::TestCaseSource::CaseSource < OpenStruct
end
module Cucumber::Formatter::LegacyApi::TestStepSource
  def self.for(test_step, result); end
end
class Cucumber::Formatter::LegacyApi::TestStepSource::Collector
  def initialize; end
  def method_missing(name, node, step_result, *_args); end
  def result; end
end
class Cucumber::Formatter::LegacyApi::TestStepSource::StepSource < OpenStruct
  def build_step_invocation(indent, matches, config, messages, embeddings); end
end
class Cucumber::Formatter::LegacyApi::Embedding < Struct
  def label; end
  def label=(_); end
  def mime_type; end
  def mime_type=(_); end
  ...
  def self.members; end
  def self.new(*arg0); end
  def send_to_formatter(formatter); end
  def src; end
  def src=(_); end
end
class Cucumber::Formatter::LegacyApi::FeaturePrinter < Struct
  def after; end
  def after_hook(_location, result); end
  def after_step_hook(_hook, result); end
  def after_test_case(test_case, test_case_result); end
  def after_test_step(test_step, result); end
  def any_test_steps_failed?; end
  def background(node, *arg1); end
  def before; end
  def before_hook(_location, result); end
  def before_hook_results; end
  def before_test_case(_test_case); end
  def before_test_step(test_step); end
  def config; end
  def config=(_); end
  def current_test_step_source; end
  def embed(src, mime_type, label); end
  def examples_table(*arg0); end
  def examples_table_row(*arg0); end
  def feature(*arg0); end
  def formatter; end
  def formatter=(_); end
  def from_first_background(from); end
  def from_hidden_background(from); end
  def from_scenario_outline_to_hidden_background(from, to); end
  def matches; end
  def matches=(_); end
  def node; end
  def node=(_); end
  ...
  def results; end
  def results=(_); end
  def same_background_as_previous_test_case?(source); end
  def same_scenario_outline_as_previous_test_case?(source); end
  def scenario(*arg0); end
  def scenario_outline(*arg0); end
  def select_step_container(source); end
  def self.[](*arg0); end
  def self.inspect; end
  def self.members; end
  def self.new(*arg0); end
  def step(*arg0); end
  def switch_step_container(source = nil); end
  def switch_to_child(child, source); end
  def to_scenario_outline(to); end
end
module Cucumber::Formatter::LegacyApi::PrintsAfterHooks
  def after_hook(result); end
  def after_hook_results; end
end
class Cucumber::Formatter::LegacyApi::AfterHookPrinter
  def after; end
  def formatter; end
  def initialize(formatter); end
  include Cucumber::Formatter::LegacyApi::PrintsAfterHooks
end
class Cucumber::Formatter::LegacyApi::BackgroundPrinter < Struct
  def after; end
  def after_hook(*arg0); end
  def after_step_hook(result); end
  def after_test_case(*arg0); end
  def before; end
  def before_hook_results; end
  def before_hook_results=(_); end
  def failed?; end
  def feature; end
  def feature=(_); end
  def formatter; end
  ...
  def self.members; end
  def self.new(*arg0); end
  def step_invocation(step_invocation, source); end
end
...
class Cucumber::Formatter::LegacyApi::HiddenBackgroundPrinter < Anonymous_Struct_35
  def after; end
  def after_hook(*arg0); end
  def after_step_hook(*arg0); end
  def after_test_case(*arg0); end
  def before; end
  def before_hook(*arg0); end
  def examples_table(*arg0); end
  def get_failed_step_source; end
  def step_invocation(_step_invocation, source); end
end
class Cucumber::Formatter::LegacyApi::ScenarioPrinter < Struct
  def after; end
  def after_step_hook(result); end
  def after_test_case(_test_case, result); end
  def before; end
  def before_hook_results; end
  def before_hook_results=(_); end
  def formatter; end
  ...
  def self.members; end
  def self.new(*arg0); end
  def step_invocation(step_invocation, _source); end
  include Cucumber::Formatter::LegacyApi::PrintsAfterHooks
end
class Cucumber::Formatter::LegacyApi::StepsPrinter < Struct
  def after; end
  def before; end
  def formatter; end
  def formatter=(_); end
  ...
  def self.members; end
  def self.new(*arg0); end
  def step_invocation(step_invocation); end
  def steps; end
end
class Cucumber::Formatter::LegacyApi::ScenarioOutlinePrinter < Struct
  def after; end
  def after_hook(*args, &block); end
  def after_step_hook(*args, &block); end
  def after_test_case(test_case, result); end
  def before; end
  def configuration; end
  def configuration=(_); end
  def examples_table(examples_table); end
  def examples_table_row(node, before_hook_results); end
  def formatter; end
  def formatter=(_); end
  def indent; end
  def last_step_result; end
  def node; end
  def node=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class Cucumber::Formatter::LegacyApi::OutlineStepsPrinter < Struct
  def configuration; end
  def configuration=(_); end
  def examples_table(*arg0); end
  def formatter; end
  ...
  def outline; end
  def outline=(_); end
  def outline_step(step); end
  def print(node); end
  def scenario_outline(_node, &descend); end
  def self.[](*arg0); end
  def self.inspect; end
  def self.members; end
  def self.new(*arg0); end
  def steps_printer; end
end
class Cucumber::Formatter::LegacyApi::ExamplesArrayPrinter < Struct
  def after; end
  def after_hook(*args, &block); end
  def after_step_hook(*args, &block); end
  def after_test_case(*args, &block); end
  def before; end
  def configuration; end
  def configuration=(_); end
  def examples_table(examples_table); end
  def examples_table_row(*args, &block); end
  def formatter; end
  def formatter=(_); end
  def self.[](*arg0); end
  def self.inspect; end
  def self.members; end
  def self.new(*arg0); end
  def step_invocation(*args, &block); end
  extend Forwardable
end
class Cucumber::Formatter::LegacyApi::ExamplesTablePrinter < Struct
  def after; end
  def after_hook(*args, &block); end
  def after_step_hook(*args, &block); end
  def after_test_case(*args); end
  ...
  def configuration; end
  def configuration=(_); end
  def examples_table_row(examples_table_row, before_hook_results); end
  def formatter; end
  def formatter=(_); end
  def legacy_table; end
  def node; end
  def node=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class Cucumber::Formatter::LegacyApi::ExampleTableRow < SimpleDelegator
  def dom_id; end
end
class Cucumber::Formatter::LegacyApi::LegacyTable < Struct
  def col_width(index); end
  def node; end
  def node=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class Cucumber::Formatter::LegacyApi::FindMaxWidth < Struct
  def char_length_of(cell); end
  def examples_table(table, &descend); end
  def examples_table_row(row, &_descend); end
  def index; end
  def index=(_); end
  def result; end
  def self.[](*arg0); end
...
class Cucumber::Formatter::LegacyApi::TableRowPrinterBase < Anonymous_Struct_36
  def after_step_hook(result); end
  def after_test_case(*_args); end
  def exception; end
  def indent; end
  def legacy_table_row; end
  include Cucumber::Formatter::LegacyApi::PrintsAfterHooks
end
class Cucumber::Formatter::LegacyApi::HeaderTableRowPrinter < Cucumber::Formatter::LegacyApi::TableRowPrinterBase
  def after; end
  def before; end
  def legacy_table_row; end
end
class Cucumber::Formatter::LegacyApi::TableRowPrinter < Cucumber::Formatter::LegacyApi::TableRowPrinterBase
  def after; end
  def already_failed?; end
  def before; end
  def step_invocation(step_invocation, source); end
end
class Cucumber::Formatter::LegacyApi::ExpandTableRowPrinter < Cucumber::Formatter::LegacyApi::TableRowPrinterBase
  def after; end
  def before; end
  def print_scenario_name(step_invocation, table_row); end
  def step_invocation(step_invocation, source); end
end
class Cucumber::Formatter::LegacyApi::Indent
  def background(node, &descend); end
  def examples_table(*arg0); end
  def examples_table_row(*arg0); end
  def initialize(node); end
  def max; end
  def of(node); end
  def outline_step(node); end
  def record_width_of(node); end
  def scenario(node, &descend); end
  def scenario_outline(node, &descend); end
  def step(node); end
end
class Cucumber::Formatter::LegacyApi::LegacyResultBuilder
  def append_to_exception_backtrace(line); end
  def describe_exception_to(formatter); end
  def duration(duration, *arg1); end
  def exception(exception, *arg1); end
  def failed; end
  def filtered_exception; end
  def filtered_step_exception(_step); end
  def initialize(result); end
  def passed; end
  def pending(exception, *arg1); end
  def scenario(name, location); end
  def scenario_outline(name, location); end
  def skipped; end
  def status; end
  def step_exception(step, configuration); end
  def step_invocation(step_match, step, indent, background, configuration, messages, embeddings); end
  def undefined; end
end
class Anonymous_Struct_37 < Struct
  ...
  def self.new(*arg0); end
  def support_code; end
  def support_code=(_); end
end
class Cucumber::Formatter::LegacyApi::RuntimeFacade < Anonymous_Struct_37
  def scenarios(status = nil); end
...
class Cucumber::Formatter::LegacyApi::Results
  def initialize; end
  def scenario_visited(scenario); end
  def scenarios(status = nil); end
  def step_visited(step); end
  def steps(status = nil); end
end
...
module Cucumber::Formatter::Console
  def collect_snippet_data(test_step, result); end
  ...
  def embed(file, mime_type, label); end
  ...
  def hook?(test_step); end
  def linebreaks(s, max); end
...
module Cucumber::Gherkin::Formatter::AnsiEscapes
  ...
  def up(n); end
  extend Cucumber::Gherkin::Formatter::AnsiEscapes
end
...
class Cucumber::Glue::Hook
  def initialize(registry, tag_expressions, proc); end
  def invoke(pseudo_method, arguments, &block); end
  def location; end
  def tag_expressions; end
  def warn_for_old_style_tag_expressions(tag_expressions); end
end
module Cucumber::Glue::ProtoWorld
  def ask(question, timeout_seconds = nil); end
  def embed(file, mime_type, label = nil); end
  def inspect; end
  ...
  def table(text_or_table, file = nil, line = nil); end
  def to_s; end
end
class String
  def indent(n); end
...
class Cucumber::Glue::StepDefinition
  ...
  def file; end
  def file_colon_line; end
  def initialize(registry, expression, proc); end
  def invoke(args); end
  def location; end
  def registry; end
  def self.create_proc(proc_or_sym, options); end
  def self.new(registry, string_or_regexp, proc_or_sym, options); end
