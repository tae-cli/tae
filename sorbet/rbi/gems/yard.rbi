...
module YARD::Templates::Helpers::MarkupHelper
  def load_markup_provider(type = nil); end
  def markup_class(type = nil); end
  def markup_file_contents(contents); end
  def markup_for_file(contents, filename); end
  def markup_provider(type = nil); end
  def self.clear_markup_cache; end
  def self.markup_cache; end
  def self.markup_cache=(arg0); end
end
module YARD::Templates::Helpers::ModuleHelper
  def prune_method_listing(list, hide_attributes = nil); end
end
...
module YARD::Templates::Helpers::HtmlHelper
  ...
  def format_types(typelist, brackets = nil); end
  def h(text); end
  ...
  def html_syntax_highlight(source, type = nil); end
  def html_syntax_highlight_plain(source); end
  def htmlify(text, markup = nil); end
  def htmlify_line(*args); end
  def insert_include(text, markup = nil); end
  def link_file(filename, title = nil, anchor = nil); end
  def link_include_file(file); end
  def link_include_object(obj); end
  def link_object(obj, title = nil, anchor = nil, relative = nil); end
  def link_url(url, title = nil, params = nil); end
  def mtime(_file); end
  def mtime_url(obj, anchor = nil, relative = nil); end
  ...
  def signature(meth, link = nil, show_extras = nil, full_attr_name = nil); end
  def signature_types(meth, link = nil); end
  def tag_attrs(opts = nil); end
  def url_for(obj, anchor = nil, relative = nil); end
  def url_for_file(filename, anchor = nil); end
