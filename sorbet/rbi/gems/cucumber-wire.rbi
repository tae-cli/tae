...
class Cucumber::Wire::StepDefinition
  def initialize(connection, data); end
  def invoke(args); end
  def location; end
...
class Cucumber::Wire::Connections
  ...
  def initialize(connections, configuration); end
...
class Cucumber::Wire::AddHooksFilter < Anonymous_Object_40
