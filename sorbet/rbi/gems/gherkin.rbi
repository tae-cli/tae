...
#
#   https://github.com/sorbet/sorbet-typed/new/master?filename=lib/gherkin/all/gherkin.rbi
#
# gherkin-5.1.0
...
class Gherkin::Token < Anonymous_Struct_38
  def detach; end
  def eof?; end
...
class Gherkin::GherkinLine::Span < Anonymous_Struct_39
end
...
class Gherkin::TokenMatcher
  ...
  def match_ScenarioOutlineLine(token); end
...
class Gherkin::Parser
  ...
  def match_ScenarioOutlineLine(context, token); end
